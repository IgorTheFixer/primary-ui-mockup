...
export const API_KEY_LOCAL_STORAGE_KEY = "OPENAI_API_KEY";
export const REACT_FLOW_LOCAL_STORAGE_KEY = "STAVE_REACT_FLOW_DATA";
export const MODEL_SETTINGS_LOCAL_STORAGE_KEY = "STAVE_MODEL_SETTINGS";
export const SAVED_CHAT_SIZE_LOCAL_STORAGE_KEY = "STAVE_SAVED_CHAT_SIZE";
