...
import { StaveNodeType } from "../../utils/types";
...
export function NavBar({
  ...
  newConnectedToSelectedNode: (nodeType: StaveNodeType) => void;
  submitPrompt: () => void;
  regenerate: () => void;
        ...
        <Menu>
          ...
          <MenuList width="300px">
            ...
            <MenuGroup title="Nodes">
              <MenuItem
                command={`${modifierKeyText}P`}
                onClick={() => newConnectedToSelectedNode(StaveNodeType.User)}
              >
                New user node
              </MenuItem>
              ...
              <MenuItem
                ...
                onClick={() => newConnectedToSelectedNode(StaveNodeType.System)}
              >
                New system node
              </MenuItem>
            </MenuGroup>
